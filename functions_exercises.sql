...
SELECT first_name, last_name, DATEDIFF(NOW(),hire_date) AS DaysWorkedForCompanny
    FROM employees WHERE (hire_date LIKE '199%') AND (MONTH(birth_date) = 12 AND DAY(birth_date) = 25) ORDER BY hire_date;
